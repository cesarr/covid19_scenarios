    ...
    <Container fluid className="py-3">
      <Row noGutters>
        <Col xs={12} md={6} className="text-center text-md-left mb-2 mb-md-0">
          <h6>Outbreak Explorer builds on the <a href="http://covid19-scenarios.org" target='_blank'>COVID-19 Scenarios</a> project led by the <a href="http://neherlab.org" target='_blank'>neherlab</a></h6>
        </Col>
